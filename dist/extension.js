...
exports.deactivate = exports.authenticateUser = exports.activate = void 0;
const vscode = __importStar(__webpack_require__(1));
const SidebarProvider_1 = __webpack_require__(2);
const authenticate_1 = __webpack_require__(194);
const express_1 = __importDefault(__webpack_require__(4));
(__webpack_require__(161).config)();
const axios_1 = __importDefault(__webpack_require__(164));
/**
...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand("vshunch.authenticate", () => {
...
function authenticateUser(url) {
    ...
    app.listen(3001, () => {
        ...
        vscode.commands.executeCommand("vscode.open", vscode.Uri.parse("https://github.com/login/oauth/authorize?client_id=1141eb58b9ab1fc3ae89&redirect_uri=http://localhost:3001/auth/github/callback"));
    });
...
const vscode = __importStar(__webpack_require__(1));
const login_1 = __webpack_require__(3);
const getNonce_1 = __webpack_require__(193);
class SidebarProvider {
    ...
    resolveWebviewView(webviewView) {
        ...
        webviewView.webview.onDidReceiveMessage(async (data) => {
            switch (data.type) {
                case "onAuthenticate": {
                    (0, login_1.authenticate)(data.value);
                    break;
                }
            }
        });
    ...
    _getHtmlForWebview(webview) {
        ...
        const stylesheetUri = webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, "media", "vscode.css"));
...
var req = __webpack_require__(149);
var res = __webpack_require__(156);
...
exports.query = __webpack_require__(126);
exports.raw = bodyParser.raw
exports["static"] = __webpack_require__(160);
...
var typeis = __webpack_require__(62)
...
var callBound = __webpack_require__(87);
var inspect = __webpack_require__(94);

var $TypeError = __webpack_require__(79);
...
var hasProto = __webpack_require__(83)();
...
var hasSymbolSham = __webpack_require__(82);
...
var callBind = __webpack_require__(88);
...
var bind = __webpack_require__(84);
var GetIntrinsic = __webpack_require__(73);
var setFunctionLength = __webpack_require__(89);
...
var hasDescriptors = __webpack_require__(93)();
...
var utilInspect = __webpack_require__(95);
...
var Router = __webpack_require__(112);
var methods = __webpack_require__(122);
var middleware = __webpack_require__(125);
var query = __webpack_require__(126);
var debug = __webpack_require__(114)('express:application');
...
var debug = __webpack_require__(103)('finalhandler')
...
var methods = __webpack_require__(122);
var mixin = __webpack_require__(124);
var debug = __webpack_require__(114)('express:router');
var deprecate = __webpack_require__(7)('express');
var flatten = __webpack_require__(119);
var parseUrl = __webpack_require__(110);
var setPrototypeOf = __webpack_require__(13)
...
var debug = __webpack_require__(114)('express:router:route');
var flatten = __webpack_require__(119);
var Layer = __webpack_require__(120);
var methods = __webpack_require__(122);
...
var debug = __webpack_require__(114)('express:router:layer');
...
var debug = __webpack_require__(114)('express:view');
...
var deprecate = __webpack_require__(7)('express');
var flatten = __webpack_require__(119);
var mime = (__webpack_require__(133).mime);
...
var createError = __webpack_require__(12)
var debug = __webpack_require__(134)('send')
...
var Negotiator = __webpack_require__(151)
var mime = __webpack_require__(64)
...
var preferredCharsets = __webpack_require__(152)
var preferredEncodings = __webpack_require__(153)
var preferredLanguages = __webpack_require__(154)
var preferredMediaTypes = __webpack_require__(155)
...
var statuses = __webpack_require__(14)
var merge = __webpack_require__(124);
var sign = (__webpack_require__(157).sign);
...
var send = __webpack_require__(133);
var extname = path.extname;
var mime = send.mime;
var resolve = path.resolve;
var vary = __webpack_require__(159);
...
const packageJson = __webpack_require__(163)
...
const FormData$1 = __webpack_require__(165);
const url = __webpack_require__(111);
const proxyFromEnv = __webpack_require__(180);
const http = __webpack_require__(123);
const https = __webpack_require__(168);
const util = __webpack_require__(17);
const followRedirects = __webpack_require__(181);
...
var parseUrl = (__webpack_require__(111).parse);
var fs = __webpack_require__(26);
var Stream = (__webpack_require__(31).Stream);
var mime = __webpack_require__(64);
var asynckit = __webpack_require__(169);
var populate = __webpack_require__(179);
...
module.exports =
{
  parallel      : __webpack_require__(170),
  serial        : __webpack_require__(177),
  serialOrdered : __webpack_require__(178)
};
...
var iterate    = __webpack_require__(171)
  , initState  = __webpack_require__(175)
  , terminator = __webpack_require__(176)
  ;
...
var defer = __webpack_require__(173);
...
var abort = __webpack_require__(174)
  , async = __webpack_require__(172)
  ;
...
var serialOrdered = __webpack_require__(178);
...
try {
	...
	const supportsColor = __webpack_require__(189);
...
/* harmony export */ });
/* harmony import */ var node_process__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(190);
/* harmony import */ var node_os__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(191);
/* harmony import */ var node_tty__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(192);
...
const Util_1 = __webpack_require__(196);
const authenticate = (fn) => {
    const app = (0, express_1.default)();
    app.listen(54321, () => {
        vscode.commands.executeCommand("vscode.open", vscode.Uri.parse(`${constants_1.apiBaseUrl}/auth/github/callback`));
    });
    app.get("/callback/:accessToken/:refreshToken", async (req, res) => {
        ...
        await Util_1.Util.globalState.update(constants_1.accessTokenKey, accessToken);
        await Util_1.Util.globalState.update(constants_1.refreshTokenKey, refreshToken);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.refreshTokenKey = exports.accessTokenKey = exports.apiBaseUrl = exports._prod_ = void 0;
exports._prod_ = process.env.NODE_ENV === "production";
exports.apiBaseUrl = "https://github.com/login/oauth/authorize?client_id=1141eb58b9ab1fc3ae89&redirect_uri=http://localhost:54321/auth/github/callback";
exports.accessTokenKey = "@vsinder/token" + (exports._prod_ ? "" : "dev");
exports.refreshTokenKey = "@vsinder/refresh-token" + (exports._prod_ ? "" : "dev");
...
class Util {
    ...
    static getRefreshToken() {
        return this.globalState.get(constants_1.refreshTokenKey) || "";
    }
    static getAccessToken() {
        return this.globalState.get(constants_1.accessTokenKey) || "";
    }
    static isLoggedIn() {
        return (!!this.globalState.get(constants_1.accessTokenKey) &&
            !!this.globalState.get(constants_1.refreshTokenKey));
    }
}
exports.Util = Util;
